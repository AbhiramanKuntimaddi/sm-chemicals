          ...
          {timeline.map((item) => (
            ...
            >
              <div className="relative z-10">
                <span className="text-4xl font-light tracking-tighter text-text-950 group-hover:text-accent-500 transition-colors duration-500 block mb-8">
                  {item.year}
                </span>
              ...
              <div className="absolute top-0 left-0 w-8 h-8 border-t border-l border-accent-500/0 group-hover:border-accent-500/20 transition-all duration-700" />
            </div>
          ))}
        </div>
      </div>
